...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-emerald-100 flex items-center justify-center p-4">
      ...
      <button 
        onClick={toggleTheme} 
        className="fixed top-4 right-4 p-2 rounded-lg bg-white/90 backdrop-blur-sm shadow-lg hover:shadow-xl transition-all duration-200 border border-emerald-200"
      >
        {theme === 'light' ? (
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {!isLogin && (
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 h-12 border-emerald-200 focus:border-emerald-500 focus:ring-emerald-500 bg-white/80"
                  required={!isLogin}
                />
              </div>
            )}
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 pr-10 h-12 border-emerald-200 focus:border-emerald-500 focus:ring-emerald-500 bg-white/80"
                required
              />
              <button
                type="button"
            ...
            <Button
              type="submit"
              disabled={loading}
              className="w-full h-12 text-white font-semibold bg-gradient-to-r from-emerald-500 to-emerald-600 hover:from-emerald-600 hover:to-emerald-700 shadow-lg hover:shadow-xl transition-all duration-200"
            >
